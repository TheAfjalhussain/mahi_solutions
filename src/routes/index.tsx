...
import {
  ArrowRight, BadgeCheck, Calendar, Clock, MessageCircle, Phone,
  Search, ShieldCheck, Sparkles, Star, ThumbsUp, Wrench, Zap,
} from "lucide-react";
    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden bg-gradient-hero text-white">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 15% 20%, oklch(0.7 0.15 220 / 0.55), transparent 45%), radial-gradient(circle at 85% 30%, oklch(0.78 0.16 60 / 0.35), transparent 45%)",
          }}
        />
        <div className="container-page relative grid lg:grid-cols-12 gap-10 lg:gap-12 py-16 md:py-24 lg:py-28 items-center">
          <div className="lg:col-span-7">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-white/30 border border-white/15">
              <Sparkles className="h-3.5 w-3.5 text-gold" /> Same-day doorstep service
            </span>
            <h1 className="mt-5 font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-balance">
              Trusted Repair Experts for{" "}
              <span className="bg-gradient-gold bg-clip-text text-transparent">All Home Appliances</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button asChild variant="soft" size="xl">
                <a href={site.phoneHref}><Phone className="h-5 w-5" /> Call Now</a>
              </Button>
            ...
            <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl">
              {stats.map((s) => (
                <div key={s.label} className="rounded-xl bg-white/10 backdrop-blur border border-white/10 px-4 py-3">
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-tech opacity-30 blur-3xl rounded-3xl" />
              <img
                src={img}
                alt="Mahi Solutions certified technician repairing a split AC"
                width={1536}
                height={1024}
                className="relative rounded-3xl shadow-elevated ring-1 ring-white/10"
              />
              <div className="absolute -bottom-5 -left-5 hidden sm:flex items-center gap-3 rounded-2xl bg-white text-foreground px-4 py-3 shadow-elevated">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-success/15 text-success">
                  <ShieldCheck className="h-5 w-5" />
                </div>
                <div>
                  <div className="text-sm font-semibold">30-day Warranty</div>
                  <div className="text-xs text-muted-foreground">on all repairs</div>
                </div>
              </div>
              <div className="absolute -top-5 -right-3 hidden sm:flex items-center gap-2 rounded-full bg-gradient-gold text-gold-foreground px-4 py-2 shadow-gold">
                <Zap className="h-4 w-4" /> <span className="text-sm font-bold">60-min response</span>
              </div>
            </div>
          </div>
        </div>
